...
$pdo->prepare("UPDATE conversions SET approval_status = 'approved' WHERE id = ?")->execute([$id]);
audit_log($pdo, 'approve_conversion', 'conversion', $id);

regenerate_csrf_token();
set_flash('success', 'Conversion approved.');
