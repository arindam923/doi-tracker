...
<div class="row g-4">
    <div class="col-12 col-lg-4">
        <div class="tf-card">
            <div class="tf-card-header"><h6 class="mb-0 fw-semibold">Entry Details</h6></div>
            <div class="card-body">
    ...
    <div class="col-12 col-lg-8">
        ...
        <div class="tf-card mb-4">
            <div class="tf-card-header"><h6 class="mb-0 fw-semibold">Field Changes</h6></div>
        ...
        <div class="row g-3">
            <div class="col-12 <?php echo ($before && $after) ? 'col-md-6' : ''; ?>">
                <div class="tf-card">
                    <div class="tf-card-header"><small class="fw-semibold text-secondary">BEFORE</small></div>
            ...
            <div class="col-12 col-md-6">
                <div class="tf-card">
                    <div class="tf-card-header"><small class="fw-semibold text-secondary">AFTER</small></div>
